...
int spawnProjectile(
    Scene scene, double startX, double startY, double dx, double dy) {
  final projectileEntity = scene.createEntity();

  if (projectileEntity != -1) {
    scene
        .getCaste<Position>('Position')
        .add(projectileEntity, Position.create(startX, startY));
    scene
        .getCaste<Velocity>('Velocity')
        .add(projectileEntity, Velocity.create(dx, dy));
    ...
    scene
        ...
        .add(projectileEntity, BoundingBox.create(8.0, 8.0));
